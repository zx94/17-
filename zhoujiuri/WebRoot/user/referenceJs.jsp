...
<body>
	...
	<!-- cart-js -->
	<script src="../user/js/minicart.min.js"></script>
	<script>
		// Mini Cart
	...
	<script src="../user/js/jquery.countup.js"></script>
	<script>
		$('.counter').countUp();
	</script>
	<!-- //stats -->
	...
	<script type="text/javascript" src="../user/js/jquery.easing.min.js"></script>
